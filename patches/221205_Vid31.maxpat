...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 814.0, 573.0, 150.0, 20.0 ],
					"text" : "Reset Sliders and PRIMR"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 818.5, 595.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 738.0, 595.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 473.75, 113.0, 230.0, 208.0 ],
					"prototypename" : "pixl",
					"varname" : "viewr[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 725.0, 34.0, 211.0, 96.0 ],
					"text" : "Playing With Colours - Analyse and Synthezise Video Colour (RGB)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 278.0, 569.0, 101.0, 74.0 ],
					"text" : "You can manually patch the outlets of the ANALYZR to the inlets of PRIMR"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 862.0, 398.0, 72.0, 33.0 ],
					"text" : "float num - type F"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 525.0, 398.0, 213.0, 33.0 ],
					"text" : "Slider object, pull at one corner to make it horizontal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 632.0, 607.0, 29.5, 22.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 574.0, 607.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 868.0, 529.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 868.0, 486.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 868.0, 443.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 762.5, 529.5, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 762.5, 486.0, 97.0, 22.0 ],
					"text" : "scale 0 127 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 762.5, 443.0, 97.0, 22.0 ],
					"text" : "scale 0 127 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 513.0, 486.0, 237.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 513.0, 527.0, 237.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 513.0, 441.0, 237.0, 26.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 616.0, 803.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 553.5, 803.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 496.0, 803.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 384.5, 633.0, 127.0, 144.0 ],
					"prototypename" : "pixl",
					"varname" : "primr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 278.0, 441.0, 208.0, 113.0 ],
					"prototypename" : "pixl",
					"varname" : "analyzr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 35.0, 547.0, 230.0, 208.0 ],
					"prototypename" : "pixl",
					"varname" : "viewr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.0, 201.0, 84.0, 196.0 ],
					"varname" : "fadr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 35.0, 234.0, 208.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "brcosr",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 308.5, 416.0, 279.75, 416.0, 279.75, 212.0, 139.0, 212.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 44.5, 425.5, 287.5, 425.5 ],
					"order" : 1,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 44.5, 382.0, 274.875, 382.0, 274.875, 422.0, 483.25, 422.0 ],
					"order" : 0,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-16::obj-58" : [ "pictctrl[7]", "pictctrl[1]", 0 ],
			...
			"obj-1::obj-11" : [ "pictctrl[11]", "pictctrl[1]", 0 ],
			...
			"obj-3::obj-8" : [ "pictctrl[8]", "pictctrl[1]", 0 ],
			"obj-3::obj-82" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
			"obj-3::obj-85" : [ "pictctrl[13]", "pictctrl[1]", 0 ],
			...
			"snapshot" : 			{
				"valuedictionary" : 				{
					"parameter_values" : 					{
						...
						"Fader" : 0.802866013071895,
						"FreqMode[4]" : 0.0,
						"Green mode" : 0.0,
						"Offset[2]" : -0.41828,
						"Playback controls" : 2.0,
						"Red mode" : 0.0,
						"Saturation" : 4.845856209150327,
						"Saturation 1" : 1.0,
						"Speed high" : 1.0,
						"Speed low" : 1.0,
						"contrast" : -1.0,
						...
						"saturation[1]" : 1.0,
						"blob" : 						{
							"Playback position" : [ 0.692857142857143 ],
							"Playback range" : [ 0.0, 1.0 ],
							"Rate range" : [ 0 ],
							"Swatch" : [ 0.0, 0.871785947712418, 0.0, 1.0, 0.333333333333333, 1.0, 0.435294117647059 ],
							"moviename" : [ "imovie_samp.mov" ],
							"moviepath" : [ "C74:/help/max/imovie_samp.mov" ],
							"pictctrl[11]" : [ 1 ],
							"range[5]" : [ 1 ],
							"textbutton[14]" : [ 1 ],
							"textbutton[2]" : [ 1 ],
...
,
						"fileref" : 						{
							"name" : "221205_Vid31",
							"filename" : "221205_Vid31.maxsnap",
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "57bb36855cdadaa321ac36f22e33da77"
						}
